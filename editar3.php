...
<body>
    <?php 
    //Archivo q se ejecuta cunado el usuario inicia sesión correctamente y quiere editar algo.
    session_start();?>
    <div class=" col-lg-12 container" style="width: 500px; height: auto;">
        <!-- Datos personales -->
        <div class="row form-edit">
            <form enctype="multipart/form-data" action="alta_edicion3.php" method="POST" role="form">
                <button class = "atras" style="border-radius: 25px;" formaction="cv_3.php"><span class="material-symbols-outlined">arrow_back</span></button>
                <br>
                ...
                <label>Nombre</label>
                <input type="text" placeholder="ej: Fulgencio" name = "nombre2" value="<?php echo $_SESSION['nombre_2'];?>">
                <label>Apellido</label>
                <input type="text" placeholder="ej: Martínez" name = "apellido2" value="<?php echo $_SESSION['apellido_2'];?>" >
                <label>Dirección</label>
                <input type="text" placeholder="ej: Av. Santa Justa Klan, 10" name = "direccion2" value="<?php echo $_SESSION['direccion_2'];?>">
                <label>Teléfono</label>
                <input type="text" placeholder="ej: 789 879 789" value="<?php echo $_SESSION['telefono_2'];?>" name = "telefono_2">
                ...
                <input type="text" placeholder="ej: Argentina" name = "pais_2" value="<?php echo $_SESSION['pais_2'];?>">
                <br>
                <label>Teléfono fijo</label>
                <input type="text" placeholder="ej: 93 543 89 32" name = "tel_fijo_2" value="<?php echo $_SESSION['tel_fijo_2'];?>">
                ...
                <textarea name="descripcion_2" rows="10" cols="30" class="textarea" value="<?php echo $_SESSION['descripcion_2'];?>"></textarea>
                <br>
                <label>Añade una foto de perfil</label>
        ...
        <!-- Habilidades -->
        <div class="row">
            <form enctype="multipart/form-data" action="alta_habil3.php" method="POST" class="form-habil-idiom">
                <h3>Habilidades:</h3>
                <?php
        ...
        <!-- Idiomas -->
        <div class="row">
            <form enctype="multipart/form-data" action="alta_idiomas3.php" method="POST" class="form-habil-idiom">
                <h3>Idiomas: </h3>
                <?php
        ...
        <!-- competencias -->
        <div class="row">
        <form enctype="multipart/form-data" action="alta_competencias3.php" method="POST" class="form-habil-idiom">
        <h3>Competencias:</h3>
        <br>
        <?php
        ...
        echo '</table>';
            ...
            <form action="cv.php"><button type="submit" formaction="cv_3.php" value="actualizar">Enviar</button></form>
        </div>
    </div>
